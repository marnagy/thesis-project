...
#@route('/shortest/<start_lat:float>:<start_lon:float>;<dest_lat:float>:<dest_lon:float>')
def distance(start_lat: float, start_lon: float, dest_lat: float, dest_lon: float):
...
#@route('/traveltime/<start_lat:float>:<start_lon:float>;<dest_lat:float>:<dest_lon:float>')
def traveltime(start_lat: float, start_lon: float, dest_lat: float, dest_lon: float):
    '''Function for HTTP method GET.
...
if __name__ == '__main__':
    ...
    app.add_route(distance , '/shortest/<start_lat:number>:<start_lon:number>;<dest_lat:number>:<dest_lon:number>')
    app.add_route(traveltime , '/traveltime/<start_lat:number>:<start_lon:number>;<dest_lat:number>:<dest_lon:number>')
